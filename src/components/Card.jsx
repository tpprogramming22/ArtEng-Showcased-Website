  ...
  return (
    <div className="bg-white rounded-md overflow-hidden shadow-sm border border-gray-200 flex flex-col h-full">
      ...
      <div className="p-3 sm:p-4 flex-grow flex flex-col">
        <h3 className="font-bold text-base sm:text-lg mb-2 text-arteng-dark line-clamp-2">
          {title}
        </h3>
            ...
            {dateTime && (
              <div className="flex items-start sm:items-center gap-1 sm:gap-2">
                <svg
                  ...
                  className="h-3 w-3 sm:h-4 sm:w-4 mt-0.5 sm:mt-0 flex-shrink-0"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
        ...
        <div className="mt-auto flex justify-center w-full">
          <Link
            href={link}
            className="inline-block bg-arteng-dark text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded text-xs sm:text-sm hover:bg-opacity-90 transition-colors w-32 text-center"
          >
            {linkText}
          </Link>
        </div>
