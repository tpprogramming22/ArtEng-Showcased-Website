    ...
    <div className="bg-white rounded-md overflow-hidden shadow-sm border border-gray-200 flex flex-col h-full">
      ...
      <div className="p-3 sm:p-4 flex-grow flex flex-col">
        ...
        <div className="mt-auto">
          <Link
            href={link}
            className="inline-block bg-arteng-dark text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded text-xs sm:text-sm hover:bg-opacity-90 transition-colors w-20 sm:w-24 text-center"
          >
            {linkText}
          </Link>
        </div>
