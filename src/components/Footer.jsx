        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-lg mb-4">
              Bringing creatives and innovators together to transform ideas into
              unforgettable experiences.
            </p>
            <div className="flex justify-center sm:justify-start space-x-4">
              <a
                href="https://www.linkedin.com/company/arteng-uk"
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/events" className="text-lg hover:text-gray-300">
                  Events
                </Link>
              </li>
              <li>
                <Link href="/news" className="text-lg hover:text-gray-300">
                  News
                </Link>
              </li>
              <li>
                <Link href="/about-us" className="text-lg hover:text-gray-300">
                  About Us
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/partners" className="text-lg hover:text-gray-300">
                  Partners
                </Link>
              </li>
              <li>
                <Link href="/faq" className="text-lg hover:text-gray-300">
                  FAQ
                </Link>
              </li>
              <li>
