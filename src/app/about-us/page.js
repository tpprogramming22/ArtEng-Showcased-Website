...
export default function AboutUsPage() {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      role: "Sales Director",
      description: "Stephen has over 45 years of experience in logistics, project management, sales, and the arts, focusing on supporting student career transitions.",
      imageUrl: "/steve.png",
    ...
    },
    {
      ...
      name: "Wendy Bennet",
      role: "Technical Lead",
      description: "Wendy is a pioneering leader for women in engineering, with achievements in precision casting and leadership roles in industry organizations.",
      imageUrl: "/wendy.png",
