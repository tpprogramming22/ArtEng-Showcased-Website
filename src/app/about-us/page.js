        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-6 relative flex-shrink-0">
              ...
              <div className="grid grid-cols-4 md:grid-cols-4 lg:grid-cols-4 gap-3 ml-3 relative flex-shrink-0">
                <div className="relative w-full md:w-10 h-10 md:h-10 flex-shrink-0">
                  <Image src="linkedin.jpg" alt={selectedMember.name} fill className="object-cover rounded-md" />
                </div>
                <div className="relative w-full md:w-10 h-10 md:h-10 flex-shrink-0">
