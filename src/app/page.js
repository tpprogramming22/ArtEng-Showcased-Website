  ...
  const featuredNews = [
    {
      ...
      description:
        "Exciting news as we expand our capabilities with this new acquisition, providing greater opportunities for innovative projects and partnerships.",
    ...
    },
    {
      ...
      description:
        "Our leadership continues to be recognized in the industry with this prestigious nomination that highlights our commitment to pushing boundaries.",
    ...
    },
    {
      ...
      description:
        "A look back at our achievements and milestones from the past year, celebrating the growth and success of our community and projects.",
  ...
  const upcomingEvents = [
    {
      ...
      description:
        "Join us for an immersive workshop exploring the latest digital art techniques and technologies.",
    ...
    },
    {
      ...
      description:
        "A panel discussion with industry leaders about the future of engineering and creative problem-solving.",
    ...
    },
    {
      ...
      description:
        "The unveiling of our new exhibition featuring works from artists and engineers who collaborated on innovative projects.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            ...
            <div className="text-center">
              <p className="text-base md:text-2xl">
                Connecting, nurturing and developing the artistic and
                engineering worlds...
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-6">
              ...
              <p className="mb-3 md:mb-4 text-gray-800 text-sm md:text-lg">
                We want to foster a creative community that blurs the lines
                between art and engineering, providing the tools, resources and
                opportunities to experiment, collaborate, and develop projects
              ...
              <div className="flex items-center justify-center mt-4 md:mt-6">
                <Link
                  href="/about-us"
                  className="bg-arteng-dark text-white px-4 md:px-6 py-1.5 md:py-2 rounded inline-block hover:bg-opacity-90 transition-colors text-sm md:text-base"
                >
                  More Info
                </Link>
              </div>
      ...
      <section className="py-10 md:py-16 px-4 md:px-8 bg-gray-50">
        <div className="container mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-center mb-6">
            <div>
              ...
              <p className="text-gray-600 text-center sm:text-left text-lg sm:text-lg">
                Meet the team behind ArtEng
              </p>
            </div>
            <Link
              href="/about-us"
              className="mt-3 sm:mt-0 bg-black text-white px-3 sm:px-4 py-1.5 sm:py-2 rounded text-xs sm:text-sm hover:bg-gray-800 transition-colors"
            >
              More Info
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            ...
            >
              ...
              <h3 className="text-base sm:text-lg font-bold group-hover:text-arteng-dark transition-colors">
                Wendy Bennett
              </h3>
              <p className="text-xs sm:text-sm">Managing Director</p>
              <p className="text-xs sm:text-sm text-center ">
                Wendy is a trailblazer for women in industry and has a
                reputation for becoming the first female in a variety of
                positions across many engineering fields. She worked within the
                precision investment casting industry for 26 years and was CEO
                and previous owner of Lost Wax Development Limited.
              </p>
            ...
            >
              ...
              <p className="text-xs sm:text-sm text-center mb-4 sm:mb-10">
                Stephen's career spans more than 45 years covering a range of
                roles including Logistics/Transport management, Project
                management, Key Account management and Sales Business
                Development.
              </p>
              <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                <div className="flex items-center text-arteng-dark">
            ...
            >
              ...
              <p className="text-xs sm:text-sm text-center ">
                ...
                business support. Having worked with hundreds of companies
                across diverse sectors, Joan has always managed to understand
                their unique challenges and opportunities that businesses face.
              </p>
            ...
            >
              ...
              <p className="text-xs sm:text-sm text-center ">
                ...
                different roles and organisations. After graduating from
                university with a marketing degree, Adam moved to London and
                worked in a busy press office for the National Consumer Council.
              </p>
        ...
        >
          ...
          <div className="flex flex-col items-center flex-grow">
            <h3 className="text-base sm:text-lg font-bold group-hover:text-arteng-dark transition-colors duration-300">
              Stephen Fletcher
            </h3>
            <p className="text-xs sm:text-sm">Creative Director</p>
      ...
      <section className="py-10 md:py-16 px-4 md:px-8 bg-white">
        <div className="container mx-auto">
          <div>
            ...
            <p className="text-gray-600 text-center sm:text-left text-lg sm:text-lg">
              Keep up to date with what's happening, what our partners have been
              up to and all our news
            </p>
          </div>
      ...
      <section className="py-10 md:py-16 px-4 md:px-8 bg-gray-50">
        <div className="container mx-auto">
          <div>
            ...
            <p className="text-gray-600 text-center sm:text-left text-lg sm:text-lg">
              Events coming soon, to book and find out more click on each image
            </p>
          </div>
